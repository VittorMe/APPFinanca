...
public partial class TransactionEdit : ContentPage
{
    ...
    public void SetTransactionToEdit(Transaction transaction)
    {
        ...
        pickerTipoPagamento.SelectedItem = pickerTipoPagamento.ItemsSource
       .Cast<string>()
       .FirstOrDefault(item => string.Equals(item, transaction.PaymentType.ToString(), StringComparison.OrdinalIgnoreCase));


        pickerTipoGrupo.SelectedItem = pickerTipoGrupo.ItemsSource
        .Cast<string>()
        .FirstOrDefault(item => string.Equals(item, transaction.Group.ToString(), StringComparison.OrdinalIgnoreCase));
